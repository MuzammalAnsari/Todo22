...
const App = () => {
    ...
    const getDocument = async () => {
        const q = query(collection(firestore, "todos"), where("list", "==", "personal"));
    ...
    return (
        <Layout >
            ...
            <Content
                style={{ minHeight: "100vh", padding: "20px", display: "flex", flexDirection: "column", background: colorBgContainer, }}><h1>Personal</h1>
                <Divider />
